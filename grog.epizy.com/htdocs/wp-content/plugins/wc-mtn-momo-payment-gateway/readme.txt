...
* Generate the API User here: [GENERATE USER](https://momodeveloper.mtn.com/docs/services/sandbox-provisioning-api/operations/post-v1_0-apiuser)
* Generate the API Key here using the reference ID in the previous request for API user: [GENERATE API KEY](https://momodeveloper.mtn.com/docs/services/sandbox-provisioning-api/operations/post-v1_0-apiuser)
